...
public abstract class Book {
    ...
    public Book(String title, String author, String isbn, String categories, String description, String imageUrl, String QRcode) {
        this.title = title;
        this.author = author;
        this.isbn = isbn;
    ...
    public Book(int id, String title, String author, String isbn, boolean available, String categories, String description, String imageUrl, String QRcode) {
        this.id = id;
        this.title = title;
        this.author = author;
        this.isbn = isbn;
